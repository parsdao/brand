...
function Wordmark({
  ...
  return /* @__PURE__ */ jsxs("div", { className: `pars-wordmark ${className}`, style: { display: "inline-flex", alignItems: "center", gap: `${gap}px`, ...style }, children: [
    /* @__PURE__ */ jsx2(Logo, { variant, size }),
    /* @__PURE__ */ jsx2("span", { className: textClassName, style: { fontSize, fontWeight: 600, letterSpacing: "-0.02em" }, children: brandName })
  ] });
}
...
function Favicon() {
  ...
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    /* @__PURE__ */ jsx3("link", { rel: "icon", type: "image/svg+xml", href: faviconUrl }),
    /* @__PURE__ */ jsx3("link", { rel: "apple-touch-icon", href: faviconUrl })
  ] });
}
